...
$observaciones = $_POST['observaciones'];
		...
		$conexion->query("insert into afiliacion (nombre, apellidos, sexo, NIF, numeroEmpleado, fechaNacimiento, direccion, poblacion, provincia, codigoPostal, entidad, numeroOficina, clasificacionProfesional, afi, fechaAfiliacion, fechaBaja , gestorAfiliacion, gestorParAfiliacion, formaDePago, CCAfiliacion, telefono, correoExternoCajamar, correoExternoPropio,situacion, observaciones) values ('$nombre', '$apellidos', '$sexo', '$NIF', '$numeroEmpleado', '$fechaNacimiento', '$direccion', '$poblacion', '$provincia', '$codigoPostal', '$entidad', '$numeroOficina', '$clasificacionProfesional', '$afi', '$fechaAfiliacion', '$fechaBaja' ,'$gestorAfiliacion', '$gestorParAfiliacion', '$formaDePago', '$CCAfiliacion', '$telefono', '$correoExternoCajamar', '$correoExternoPropio','$situacion', '$observaciones')");

		
        /*borro esa linea de BajasAfiliacion*/
        $conexion->query("DELETE FROM bajasafiliacion where NIF = '$NIF'");
