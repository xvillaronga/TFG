$(document).ready(function(){	
		...
		$('#service').on('input',function(){
			...
			$("#resultadoEmpleado").fadeOut(1000); // hacemos desaparecer is habia algun empleado antes en pantalla.
			...
			$.ajax({
	            ...
	            url: "../php/busqueda/autocompletaEmpleado.php",
         ...
         $("#busquedaEmpleado").click(function(){
         	...
         	if ($('#service').val()!=""){
				...
				if (idEmpleado!=null){
					...
					$.post("../php/busqueda/volcarDatosEmpleado.php",{usuario: idEmpleado},function(res){
				               ...
				               /************IMPRIMIR BOLETIN AFILIACION**********/
				               	...
				               	$("#imprimirBA").click(function(){
										...
										window.open("../php/busqueda/boletinAfiliacionRelleno.php?var="+idEmpleado, '_blank');			
...
/*****************AUTOCOMPLETA OFICINA**************************************/
		...
		$('#service2').on('input',function(){
			...
			$("#resultadoOficina").fadeOut(1000); // hacemos desaparecer is habia alguna oficina antes en pantalla.
			...
			$.ajax({
	            ...
	            url: "../php/busqueda/autocompletaOficina.php",
         ...
         $("#busquedaOficina").click(function(){
         	...
         	if ($('#service2').val()!=""){
				...
				if (idOficina!=null){
					...
					$.post("../php/busqueda/volcarDatosOficina.php",{ofi: idOficina},function(res){
		               ...
		               $(".empleadoClicable").click(function(){
		               		...
		               		//alert("salida "+identificacioEmpleat);

		               		localStorage.setItem('usuarioExtra',identificacioEmpleat);

		               		window.open('../html/busqueda/volcarDatosEmpleadoExtra.html');
               							...
               							const swalWithBootstrapButtons = swal.mixin({
			                                  ...
			                                  swalWithBootstrapButtons({
			                                    ...
			                                    if (result.value) {
													...
													$.post("../php/busqueda/eliminarVisitaOficina.php", {posi: posicion},function(res){
														//alert(res);
